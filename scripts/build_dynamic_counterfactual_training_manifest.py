...
def build_training_rows(
    pair_rows: list[dict[str, str]], generated: dict[int, dict[str, object]]
) -> list[dict[str, str]]:
        ...
        row.update(
            {
                ...
                "generated_video": "",
                "desired_target_video": str(video),
...
def main() -> None:
    ...
    rows = build_training_rows(pair_rows, load_generated_items(args.generation_manifest))
