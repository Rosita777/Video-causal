...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/waterdrop_implicit_pilot100_wan}"
LOG_ROOT="${LOG_ROOT:-$PROJECT_ROOT/logs/waterdrop_implicit_pilot100_wan}"
...
run_shard() {
  local shard="$1"
  local gpu="$2"
  local prompts="prompts/waterdrop_implicit_pilot100_shard_${shard}.txt"
  local seeds
