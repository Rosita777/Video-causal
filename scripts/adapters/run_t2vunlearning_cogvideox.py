#!/usr/bin/env python3
"""Plan or run the T2VUnlearning-CogVideoX adapter for project prompt files."""
...
def build_external_config(args: argparse.Namespace) -> dict[str, object]:
    ...
    return {
        ...
        "notes": "Adapter expects the external T2VUnlearning CogVideo runner and concept regularization training code. It records project prompt metadata and delegates real training/generation when available.",
    }
