#!/usr/bin/env python3
"""Run a VideoEraser-style ZeroScope/ModelScope baseline proxy."""
...
LOCAL_METHOD = "spea_arng_zeroscope_proxy_v0"
...
def implementation_config(args: argparse.Namespace) -> dict[str, object]:
    return {
        ...
        "notes": (
            "ZeroScope proxy for VideoEraser-style inference: replace the target "
            "concept in the positive prompt, use the target as negative guidance, "
            "and push prompt embeddings away from the original concept-bearing prompt."
        ),
    }
