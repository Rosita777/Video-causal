...
exec "$PYTHON" scripts/train_wan_waterdrop_lora.py \
  ...
  --output-dir outputs/adapters/collision_general_preserve68_balanced_pw16_150 \
  --role all --objective dual_traj --balanced-roles \
  --max-steps 150 --save-every 50 --learning-rate 1e-4 \
